...
const SOURCE_DATASET = "analytics_377774588"; /* the database containing the GA4 BigQuery exports */
...
const SEEDS_DATASET = "dataform_ga4_seed"; /* the database containing the GA4 BigQuery data mapping seeds such as source categories */
const STAGING_DATASET = "dataform__ga4_staging";
const INTERMEDIATE_DATASET = "dataform_ga4_intermediate";
const OUTPUT_DATASET = "dataform_ga4_output";
const START_DATE = 20240613; /* data will be pulled starting this date */
